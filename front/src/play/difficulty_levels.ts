...
const difficultyLevels: Dictionary<DifficultyLevel, DifficultyLevelSettings> = {
    [DifficultyLevel.None]: { minResult: -1, maxResult: -1, questionsToAnswer: -1, totalLifes: -1 },
    [DifficultyLevel.Easy]: { minResult: 1, maxResult: 30, questionsToAnswer: 10, totalLifes: 5 },
    [DifficultyLevel.Medium]: { minResult: 1, maxResult: 60, questionsToAnswer: 15, totalLifes: 4 },
    [DifficultyLevel.Hard]: { minResult: 1, maxResult: 100, questionsToAnswer: 20, totalLifes: 3 },
}
